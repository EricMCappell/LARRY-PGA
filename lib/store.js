...
// The file driver is for local development only. It's loaded lazily, and the
// turbopackIgnore comments keep the bundler from tracing the whole project into
// the deployed function (which bloats the bundle and can fail the build).
async function fsp() {
  return import(/* turbopackIgnore: true */ 'node:fs/promises');
}
